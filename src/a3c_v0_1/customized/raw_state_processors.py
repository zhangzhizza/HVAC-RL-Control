...
def raw_state_process_pass(raw_state):
	"""
...
def raw_stateLimit_process_pass(raw_stateLimit):
	"""
...
raw_state_process_map = {'cslDx_1': [raw_state_process_pass, raw_stateLimit_process_pass],
						 'direct_pass': [raw_state_process_pass, raw_stateLimit_process_pass],
