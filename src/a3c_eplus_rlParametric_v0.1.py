...
def main():
    ...
    metric_func = metric_func_dict[args.metric_func]
    ...
    effective_main(args, reward_func, rewardArgs, metric_func, train_action_func, eval_action_func, train_action_limits, 
