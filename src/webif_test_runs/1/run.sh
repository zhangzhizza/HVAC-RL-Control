python ../../a3c_eplus_rlParametric_v0.1.py --env Model1-Cool-v1 --max_interactions 1000 --window_len 6 \
...
--violation_penalty_scl 10 --eval_epi_num 1 --activation linear --model_type nn --model_param 8 1 \
