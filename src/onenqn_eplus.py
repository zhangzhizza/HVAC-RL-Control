...
def main(): 
    ...
    parser.add_argument(
        '-o', '--output', default='onenqn-res', help='Directory to save data to')
    ...
    parser.add_argument('--eval_epi_num', default=5, type=int);#######3
    ...
    parser.add_argument('--burn_in_size', default=10, type=int);
   ...
   # env_eval = wrappers.Monitor(gym.make(args.env), args.output + '/eval_res', video_callable = lambda episode_id: episode_id%20 == 0);
    ...
    onenqnAgent = OneNQNAgent(preprocessor, replayMem, args.gamma
