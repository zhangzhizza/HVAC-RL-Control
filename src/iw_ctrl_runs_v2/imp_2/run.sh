python ../../a3c_eplus_iw_v0.1.py --env IW-imp-v9702 --max_interactions 10000000 --window_len 3 --state_dim 13 --num_threads 1 \
--action_space iw_af4_3 --save_freq 500000 --eval_freq 0 --job_mode Train \
--test_env IW-imp-v9702 --err_penalty_scl 0.20 --train_act_func 10 --eval_act_func 10 --reward_func 13 --init_e 0.0 --rwd_e_para 2.5 --rwd_p_para 1.0 \
