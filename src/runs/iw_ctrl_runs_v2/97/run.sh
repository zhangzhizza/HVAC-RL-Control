...
--test_env IW-realWeather-v9701 --err_penalty_scl 0.20 --train_act_func 8 --eval_act_func 8 --reward_func 15 --init_e 0.0 --rwd_e_para 2.5 --rwd_p_para 1.0 \
