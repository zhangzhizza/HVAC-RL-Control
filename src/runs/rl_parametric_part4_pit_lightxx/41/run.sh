python ../../../a3c_eplus_rlParametric_v0.1.py --env Part4-Light-Pit-Train-v1 --max_interactions 2500000 --window_len 20 \
--state_dim 10 --num_threads 16 --action_space part4_v1 --save_freq 500000 --eval_freq 50000 \
...
--is_warm_start True --model_dir ../38/Part4-Light-Pit-Train-v1-res1/model_data/model.ckpt-2000000
