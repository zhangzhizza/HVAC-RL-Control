python ../../../a3c_eplus_rlParametric_v0.1.py --env Part4-Light-Pit-Train-v1 --max_interactions 2000000 --window_len 20 \
...
--reward_func part4_prior_v1 --metric_func part4_v1 --init_e 0.0 --rwd_e_para 1.0 --rwd_p_para 1.0 \
