python ../../../a3c_eplus_rlParametric_v0.1.py --env Part3-NA-Pit-Train-v1 --max_interactions 2500000 --window_len 21 \
...
--train_act_func part3_pit_sto_v1 --eval_act_func part3_pit_det_v1 \
