python ../../../a3c_eplus_rlParametric_v0.1.py --env Part4-Heavy-Pit-Train-Repeat-v2 --max_interactions 3000000 --window_len 10 \
--state_dim 11 --num_threads 16 --action_space part4_v3 --save_freq 500000 --eval_freq 50000 \
--job_mode Train --test_env Part4-Heavy-Pit-Test-Repeat-v3 Part4-Heavy-Pit-Test-Repeat-v4 \
...
--is_warm_start True --model_dir Part4-Heavy-Pit-Train-Repeat-v2-res1/model_data/model.ckpt-3000000
