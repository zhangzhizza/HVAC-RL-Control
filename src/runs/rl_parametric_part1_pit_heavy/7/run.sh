python ../../../a3c_eplus_rlParametric_v0.1.py --env Part1-Heavy-Pit-Train-v1 --max_interactions 5000000 --window_len 1 \
...
--isNoisyNet True --isNoisyNetEval_rmNoise True --clip_norm 1.0
