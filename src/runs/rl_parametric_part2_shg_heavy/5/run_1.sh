python ../../../a3c_eplus_rlParametric_v0.1.py --env Part2-Heavy-Shg-Train-v1 --max_interactions 2500000 --window_len 14 \
--state_dim 71 --num_threads 16 --action_space part2_v1 --save_freq 500000 --eval_freq 100000 \
--job_mode Train --test_env Part2-Heavy-Shg-Test-v1 Part2-Heavy-Shg-Test-v2 Part2-Heavy-Shg-Test-v3 Part2-Heavy-Shg-Test-v4 \
...
--is_warm_start True --model_dir Part2-Heavy-Shg-Train-v1-res1/model_data/model.ckpt-5000000
