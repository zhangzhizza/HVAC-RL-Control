python ../../../a3c_eplus_rlParametric_v0.1.py --env Part1-Light-Pit-Train-v2 --max_interactions 2500000 --window_len 35 \
--state_dim 71 --num_threads 16 --action_space part1_v1 --save_freq 500000 --eval_freq 100000 \
--job_mode Train --test_env Part1-Light-Pit-Test-v1 Part1-Light-Pit-Test-v2 \
