...
--h_regu_frac 1.0 0.1 0.01 --forecast_dim 0 --rmsprop_decay 0.99 --rmsprop_momet 0.0 --train_freq 25 \
...
--isNoisyNetEval_rmNoise True --eval_env_res_max_keep 50 --clip_norm 0.1 \
--h_decay_bounds 500000 1000000
