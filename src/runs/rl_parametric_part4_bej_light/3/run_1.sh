python ../../../a3c_eplus_rlParametric_v0.1.py --env Part4-Light-Bej-Train-Repeat-v2 --max_interactions 3000000 --window_len 8 \
--state_dim 11 --num_threads 16 --action_space part4_v3 --save_freq 500000 --eval_freq 50000 \
--job_mode Train --test_env Part4-Light-Bej-Test-Repeat-v3 Part4-Light-Bej-Test-Repeat-v4 \
...
--learning_rate 0.0001 --learning_rate_decay_rate 1.0 --learning_rate_decay_steps 100000 --debug_log_prob 0.001 \
--isNoisyNet True --isNoisyNetEval_rmNoise True --eval_env_res_max_keep 50 --clip_norm 1.0 \
--is_warm_start True --model_dir Part4-Light-Bej-Train-Repeat-v2-res1/model_data/model.ckpt-3000000
