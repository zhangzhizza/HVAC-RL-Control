python ../../../a3c_eplus_rlParametric_v0.1.py --env Part3-NA-Shg-Train-v1 --max_interactions 1500000 --window_len 29 \
...
--is_warm_start True --model_dir Part3-NA-Shg-Train-v1-res1/model_data/model.ckpt-2500000
