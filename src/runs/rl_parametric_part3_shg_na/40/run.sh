python ../../../a3c_eplus_rlParametric_v0.1.py --env Part3-NA-Shg-Train-v1 --max_interactions 500000 --window_len 29 \
--state_dim 17 --num_threads 16 --action_space part3_v1 --save_freq 500000 --eval_freq 10000 \
